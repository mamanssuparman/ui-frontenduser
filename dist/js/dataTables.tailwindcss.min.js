...
$.extend( true, DataTable.defaults, {
	dom:
		"<'grid grid-cols-1 md:grid-cols-2'" +
			...
			"<'my-2 col-span-2  min-w-full bg-white dark:bg-gray-800 'tr>" +
			"<'self-center'i>" +
...
$.extend( DataTable.ext.classes, {
	...
	tailwindcss: {
		...
		thead: {
			row: 'text-black dark:border-gray-700/50',
			cell: 'px-3 py-4 bg-gray-100/75 font-semibold text-left dark:text-black dark:bg-gray-700/25'
		},
		tbody: {
